...
$query=mysqli_query($koneksi, "select * from motor where kode_motor='$_GET[kode_motor]'");
$no=1;
...
$query2=mysqli_query($koneksi, "select * from konsumen where user='$_SESSION[namamember]'");
$no=1;
